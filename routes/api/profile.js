...
router.delete("/experience/:exp_id", auth, async (req, res) => {
  try {
    ...
    // Get remove index
    const removeIndex = profile.experience.map(elem => elem.id).indexOf(req.params.exp_id);
...
router.delete("/education/:edu_id", auth, async (req, res) => {
  try {
    ...
    // Get remove index
    const removeIndex = profile.education.map(elem => elem.id).indexOf(req.params.edu_id);
